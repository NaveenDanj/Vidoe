            ...
            <div class="video-block section-padding">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="main-title">
                                ...
                                <h6>Search Results for <?php echo $search_string ?></h6>
                            </div>
                        </div>

                        <?php
                        
                        $sql_get_vids = "SELECT * FROM video , account WHERE ( title LIKE '%".$search_string."%' OR tags LIKE '%".$search_string."%' OR cast LIKE '%".$search_string."%' OR video_about LIKE '%".$search_string."%' ) AND video.email = account.email ";
                        $res = $conn -> query($sql_get_vids);
                ...
                <div class="video-block section-padding">
                    <div class="row">
                        ...
                        $sql_get_channel = "SELECT * FROM account WHERE fname LIKE '%".$search_string."%' OR lname LIKE '%".$search_string."%' OR username  LIKE '%".$search_string."%' ";
                        $res = $conn -> query($sql_get_channel);

                        while($row = $res -> fetch_assoc()){

                            $get_user_data_sql = "SELECT * FROM account WHERE email = '".$row['email']."' ";
                                        ...
                                        <div class="channels-card">
                                            <div class="channels-card-image">
                                                ...
                                                <form action = "unsub.php" method = "GET">
                                                    ...
                                                    <button type="submit" class="btn btn-outline-secondary btn-sm">Subscribed<strong>1.4M</strong></button></div>
                                                </form>
                                            </div>
                                            <div class="channels-card-body">
                                                <div class="channels-title">
                                                    <a href="#">'.$row_acc['fname'].' '.$row_acc['lname'].'</a>
                                                </div>
