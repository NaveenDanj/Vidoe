...
if(isset($_POST['query_search'])){

    $search_string = $_POST['query_search'];
                ...
                <nav class="navbar navbar-expand-lg navbar-light">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        ...
                        <form action="" method="POST" class="form-inline my-2 my-lg-0">
                            ...
                            <button name="query_search" class="btn btn-outline-success btn-sm my-2 my-sm-0"type="submit"><i class="fas fa-search"></i></button> &nbsp;&nbsp;&nbsp;
                        </form>
            ...
            <div class="container-fluid">
                <div class="video-block section-padding">
                    <div class="row">
                        ...
                        $sql_get_vid = "SELECT * FROM video , account WHERE video.email = '".$row_user['email']."' AND account.email = video.email  AND ( video.title LIKE '%".$search_string."%' OR video.tags LIKE '%".$search_string."%' OR video.cast LIKE '%".$search_string."%' OR video.video_about LIKE '%".$search_string."%' ) ";
