...
$sql_cat_vids = "SELECT * FROM category , video_cat , video WHERE category.id = video_cat.cat_id AND video.id = video_cat.video_id AND video_cat.cat_id = '$cat_name' "; 

$row_cat_vid = get_data($sql_cat_vids , $conn);


$get_cat_name = "SELECT * FROM category WHERE id = '$cat_name' ";
$res_cat_name = $conn -> query($get_cat_name);
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="main-title">
                                ...
                                <h6>Category - <?php echo $row_cat_name['name'] ?></h6>
                            </div>
                        </div>

                        <?php
                        
                        $sql_get_cat_video = "SELECT * FROM video , account , video_cat WHERE video_cat.video_id = video.id AND video.email = account.email AND video_cat.cat_id = '$cat_name'  ";
                        $res = $conn -> query($sql_get_cat_video);
