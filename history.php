            ...
            <div class="container-fluid">
                <div class="video-block section-padding">
                    <div class="row">
                        ...
                        $sql = "SELECT * FROM history , video , account WHERE history.video_id = video.id AND video.email = account.email AND history.user_email = '$user_email' ORDER BY history.his_id DESC ";
                            ...
                            echo ' <div class="col-xl-3 col-sm-6 mb-3">
                                        ...
                                        <div class="video-card history-video">
                                            ...
                                            <div class="video-card-image">
                                                <a class="video-close" href="history_del.php?video_id='.$row['id'].'&timestamp='.$row['timestamp'].'"><i class="fas fa-times-circle"></i></a>
                                                <a class="play-icon" href="video_page.php?video_id='.$row['id'].'"><i class="fas fa-play-circle"></i></a>
                                                <a href="#"><img class="img-fluid" style="height : 250px; object-fit: cover;" src="./uploads/thumbnail/'.$row['thumbnail'].'" alt=""></a>
                                                <div class="time"></div>
                                            </div>
                                            ...
                                            <div class="video-card-body">
                                                ...
                                                <div class="video-page text-success"><a href="account_view.php?user_id='.$row['username'].'" >
                                                    '.$row['fname'].' '.$row['lname'].' </a> <a title="" data-placement="top" data-toggle="tooltip" 
                                                        data-original-title="Verified"><i
                                                            class="fas fa-check-circle text-success"></i></a>
                                                </div>

                                                <div class="video-view">
                                                    '.$row['views'].' views &nbsp;<i class="fas fa-calendar-alt"></i> '.$row['his_date'].'
                                                </div>
