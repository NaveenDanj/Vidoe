            ...
            <div class="single-channel-nav">
                <nav class="navbar navbar-expand-lg navbar-light">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        ...
                        <form method="POST" action="user_account_search.php" class="form-inline my-2 my-lg-0">
                            <input class="form-control form-control-sm mr-sm-1" type="search" name = "query" placeholder="Search" aria-label="Search">
                            <input type="hidden" name="prev_page" value="user_account.php" />
            ...
            <div class="container-fluid">
                ...
                <div class="video-block section-padding">
                    ...
                    <div class="row">
                        ...
                        $sql_get_vid = "SELECT * FROM video , account WHERE video.email = account.email AND video.email = '$user_email' "; 
